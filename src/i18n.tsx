...
const dictionaries: Record<Lang, Dict> = {
  es: {
    ...
    "hero.subtitle": "Más de 20 años de ejecución comercial comprobada en México y mercados internacionales. Diseñamos estrategias de entrada, ecosistemas de distribución y escalamos productos hacia mercados de alto crecimiento.",
    "hero.cta1": "Agenda una consultoría",
    "hero.cta2": "Conoce nuestros servicios",
    "hero.stat1": "+20 años", "hero.stat1d": "de ejecución comercial",
  ...
  en: {
    ...
    "hero.subtitle": "Over 20 years of proven commercial execution in Mexico and global markets. We architect market entry strategies, build high-impact distribution ecosystems, and scale products into high-growth markets.",
  ...
  pt: {
    ...
    "hero.subtitle": "Mais de 20 anos de execução comercial comprovada no México e em mercados internacionais. Desenhamos estratégias de entrada, ecossistemas de distribuição e escalamos produtos em mercados de alto crescimento.",
